import { promptSchema } from "@/lib/validations/messages";
...
export async function POST(req: Request) {
  try {
    ...
    const data = promptSchema.parse(json);
      ...
      messages: [
        {
          ...
          content: [
            ...
            "You're tasked with writing a good looking and beautiful react component using typescript and tailwind for a website.",
        ...
        },
        {
          ...
          content: [
            ...
            `- Component Description: ${data.prompt}\n`,
